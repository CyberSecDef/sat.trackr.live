...
final class ReentryListController
{
     ...
     */
    #[OA\Get(
        path: '/api/v1/reentries/upcoming',
        summary: 'Predicted reentries from Space-Track TIP',
        tags: ['Reentries'],
        parameters: [new OA\Parameter(name: 'within_hours', in: 'query', schema: new OA\Schema(type: 'integer', default: 168, maximum: 720))],
        responses: [
            new OA\Response(response: 200, description: 'Reentries ordered by predicted_decay ASC', content: new OA\JsonContent(properties: [
                new OA\Property(property: 'data', type: 'array', items: new OA\Items(type: 'object', properties: [
                    new OA\Property(property: 'norad_id',         type: 'integer'),
                    new OA\Property(property: 'name',             type: 'string'),
                    new OA\Property(property: 'predicted_decay',  type: 'string', format: 'date-time'),
                    new OA\Property(property: 'window_seconds',   type: 'integer', nullable: true),
