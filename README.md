...
See [`docs/phase5.md`](docs/phase5.md) for the locked plan + decisions. Phase 5 is closed; see [`docs/phase6.md`](docs/phase6.md) for the optional follow-up outline.
