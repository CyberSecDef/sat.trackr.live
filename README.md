...
See [`docs/phase5.md`](docs/phase5.md) for the locked Phase 5 plan + decisions. Phase 6 is also closed — see [`docs/phase6.md`](docs/phase6.md) for the locked plan (now retired into status-banner form). Project is in maintenance mode; any future phase would be planned fresh.
