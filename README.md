...
See [`docs/phase5.md`](docs/phase5.md) for the outline. TL;DR after chunk 2: OpenAPI 3.1 docs + Swagger UI, OG image generator, sitemap + structured data, deep-link sharing via Web Share, real glTF for marquee satellites.
